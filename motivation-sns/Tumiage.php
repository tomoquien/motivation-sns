...
if (isset($_FILES['upfile']['error']) && is_int($_FILES['upfile']['error']) && $_FILES["upfile"]["name"] !== ""){
            ...
            $sql = "INSERT INTO tbtest (fname, extension, raw_data,name, comment,ts) VALUES (:fname, :extension, :raw_data,:name, :comment, :ts);";
...
if(empty($nam) ==false && empty($com) ==FALSE){
        ...
        //テーブル追加
        $sql = $pdo -> prepare("INSERT INTO tbtest (name, comment,ts) VALUES (:name, :comment, :ts)");
...
<html>
	...
	<body>
		...
		<form method="POST" action="Tumiage.php" enctype="multipart/form-data" >
		<input type="hidden" name="namae" value = "<?php echo htmlspecialchars($_SESSION["NAME"], ENT_QUOTES); ?>"><br>
		<li class="new">今日の積み上げ</li><br><br><textarea name="comment" rows="10" cols="40">【今日の積み上げ】
...
■
		...
		<ul class="toukou">
	        ...
	        <form method="POST" action="Tumiage.php">
